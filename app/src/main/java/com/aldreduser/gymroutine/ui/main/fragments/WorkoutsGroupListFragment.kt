 ...
 * Use the [WorkoutsGroupListFragment.newInstance] factory method to
...
class WorkoutsGroupListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment WorkoutsGroupListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            WorkoutsGroupListFragment().apply {
